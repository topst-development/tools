...
def build_tag_struct():
    ...
    ufs_tag.options = [
        ...
        text_option('lane', 3, 3, {'2lane':('2 data lane', 0), '1lane':('1 data lanes', 1)}),
    ...
    scfw_mmc_tag.options = [
        ...
        text_option('speed_mode', 8, 10, {'hs400':('hs400', 0), 'hs200':('hs200', 1), 'ddr':('ddr', 2), 'high':('high', 3), 'default':('default', 4), 'hs400es':('hs400es', 5)}),
        range_option('otap', 11, 15, (0, 0x1f)),
        range_option('hs400_rx_pos', 16, 19, (0, 0xf)),
        range_option('hs400_rx_neg', 20, 23, (0, 0xf)),
        range_option('clk_tap', 24, 28, (0, 0x1f)),
        range_option('clk_gate', 29, 29, (0, 0x1))
    ]
    ...
    # add 'ufs' tag below the 'scfw' tag
    scfw_ufs_tag = bconf_tag('ufs', 0x90, 0x4, scfw_tag)
    scfw_tag.child_tags.append(scfw_ufs_tag)
    # add options for 'scfw/ckc' tag
    scfw_ufs_tag.options = [
        range_option('gear', 0, 1, (0, 0x3)),
        range_option('lane', 2, 2, (0, 0x1)),
		text_option('rate', 3, 3, {'Rate_B':('Rate_B', 0), 'Rate_A':('Rate_A', 1)}),
        range_option('amp', 4, 8, (0, 0x1f)),
        range_option('emph', 9, 10, (0, 0x3)),
        range_option('eq', 11, 13, (0, 0x7)),
        range_option('cfg_ctrl', 31, 31, (0, 0x1))
    ]
