...
# parameter related to all/perbank refresh at each DRAM temperature step.
# ABR EN is for perbank refresh setting at each DRAM temperature step.
# ex) 
# bit[3] = 0 : set perbank refresh when Temp status is 3.
# bit[4] = 1 : set allbank refresh when Temp status is 4.
abr_en_value = 0x0
abr_en_en = 1 # set high to activate abr_en_value in dram parameter. set low to configure ABR EN as 0xE( default ).
sw_refrate = 3 # fixed Temp status for refresh rate when MR4 sensing is disabled.
# fixed parameter
adv_target_ref = 0
...
array_add = [qos_cfg4_en, qos_cfg5_en, qos_cfg4_val, qos_cfg5_val]
array = array + array_add
